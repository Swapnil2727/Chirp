...
fun ChirpPrimaryButtonPreview() {
    ChirpTheme(darkTheme = true) {
        ChirpButton(text = "Chirp button!", onClick = {}, style = ChirpButtonStyle.PRIMARY)
    }
}
...
fun ChirpSecondaryButtonPreview() {
    ChirpTheme(darkTheme = true) {
        ChirpButton(text = "Chirp button!", onClick = {}, style = ChirpButtonStyle.SECONDARY)
    }
}
...
fun ChirpDestructivePrimaryButtonPreview() {
    ChirpTheme(darkTheme = true) {
        ChirpButton(text = "Chirp button!", onClick = {}, style = ChirpButtonStyle.DESTRUCTIVE_PRIMARY)
    }
}
...
fun ChirpDestructiveSecondaryButtonPreview() {
    ChirpTheme(darkTheme = true) {
        ChirpButton(text = "Chirp button!", onClick = {}, style = ChirpButtonStyle.DESTRUCTIVE_SECONDARY)
    }
}
...
fun ChirpTextButtonPreview() {
    ChirpTheme(darkTheme = true) {
        ChirpButton(text = "Chirp button!", onClick = {}, style = ChirpButtonStyle.TEXT)
    }
}
